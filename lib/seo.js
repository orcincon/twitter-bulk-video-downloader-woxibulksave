...
export const BRAND = {
  ...
  alternateNames: ['WoxiBulkSave', 'WBS Tool', 'WBS Kaydet'],
};

/** Per-language SEO copy — titles lead with WBS for branded search */
export const SEO_BY_LANG = {
  en: {
    title: 'WBS - Twitter/X Bulk Video Save Tool',
    description:
      'With WBS, save X (Twitter) post videos one by one or in bulk. Free, fast and secure media saving.',
    keywords: [
      'WBS',
      'WBS Twitter',
      'WBS X video',
      ...
      'Twitter video save',
      'X media save tool',
      'bulk tweet video save',
      'WoxiBulkSave',
    ],
  },
  tr: {
    title: 'WBS - Twitter/X Toplu Video Kaydetme Aracı',
    description:
      'WBS ile X (Twitter) gönderi videolarını ister tek tek isterseniz toplu olarak kaydedin. Ücretsiz, hızlı ve güvenli medya kaydetme aracı.',
    keywords: [
      'WBS',
      'WBS kaydet',
      'WBS Twitter',
      'WBS X video',
      'WBS toplu kayıt',
      'Twitter video kaydet',
      'X video kaydetme aracı',
      'toplu tweet kaydetme',
      'WoxiBulkSave',
    ],
  },
  de: {
    ...
    description:
      'Mit WBS X (Twitter)-Beitragsvideos einzeln oder in Masse speichern. Kostenloses, schnelles und sicheres Medienspeicher-Tool.',
    keywords: [
      'WBS',
      'WBS Twitter',
      'WBS X Video',
      'WBS Massenspeicherung',
  ...
  es: {
    title: 'WBS - Guardado masivo de videos X/Twitter',
    description:
      'Con WBS, analice vídeos de publicaciones de X (Twitter) uno a uno o en masa. Herramienta gratuita, rápida y segura de guardado de medios.',
    keywords: [
      'WBS',
      'WBS Twitter',
      'WBS X video',
      'WBS guardado masivo',
      'guardado de video Twitter',
      'herramienta X guardado',
      'WoxiBulkSave',
    ],
  },
};
