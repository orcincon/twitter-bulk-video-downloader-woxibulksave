...
export const SEO_BY_LANG = {
  en: {
    ...
    description:
      'WBS analyzes Twitter and X post videos in bulk. Free, fast and secure media analysis. Search WBS for HD video analysis and archive.',
    keywords: [
      'WBS',
      'WBS Twitter',
      'WBS X video',
  ...
  tr: {
    ...
    description:
      'WBS ile Twitter ve X gönderi videolarını toplu analiz edin. Ücretsiz, hızlı ve güvenli medya analiz aracı. WBS aramasıyla HD video analizi.',
    keywords: [
      'WBS',
      'WBS analiz',
      'WBS Twitter',
  ...
  de: {
    ...
    description:
      'WBS analysiert Twitter- und X-Beitragsvideos in großen Mengen. Kostenloses, schnelles und sicheres Medienanalyse-Tool.',
    keywords: [
      'WBS',
      'WBS Twitter',
      'WBS X Video',
  ...
  es: {
    ...
    description:
      'WBS analiza videos de publicaciones de Twitter y X en masa. Herramienta gratuita, rápida y segura de análisis de medios.',
    keywords: [
      'WBS',
      'WBS Twitter',
      'WBS X video',
